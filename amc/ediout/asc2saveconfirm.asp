<html>
<head>
<META HTTP-EQUIV="REFRESH" content="3;URL=asc2.asp">
<TITLE>confirm</title>
</head>
<body bgcolor=#ffffff>

<%
   gasc2confirm=Request.QueryString("gasc2confirm")
   gnumber=Request.QueryString("gnumber")
   Set Conn=Server.CreateObject("ADODB.Connection")
   Conn.Open ("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.Mappath("edi_out.mdb"))
   sql="Update t_com set asc2confirm='"&Request.Form("gasc2confirm")& "' where Qnumber="&Request.form("gnumber")
