<%@ Page Language="VB" AutoEventWireup="false" CodeFile="inbox2.aspx.vb" Inherits="inbox" %>
        ...
        <ContentTemplate>
         ...
         <asp:Label ID="Label3" runat="server" Text="Label"></asp:Label> Currently Online<br />
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                Font-Size="10pt" GridLines="Vertical" PageSize="15" Width="983px">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="สถานะ">
                        ...
                        <ItemTemplate>
                            <asp:Literal ID="L1" runat="server" Text='<%#ImagesGet(Eval("Id")) %>'></asp:Literal>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField>
                ...
                <PagerStyle BackColor="Silver" BorderColor="Black" Font-Bold="True" 
                    Font-Names="MS Sans Serif" Font-Strikeout="False" ForeColor="Blue" 
