<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Precompose.aspx.vb" Inherits="compose1" %>
...
<table align=center  border=1 cellspacing=0 cellpgadding=0 style="background-color: aliceblue" id="TABLE1" >
	...
	<tr><td colspan=3 class="style1"><font face='ms Sans Serif' size=1>จาก :
        ...
        <asp:Label ID="Label7" runat="server" Style="font-size: 10pt; color: red" Text="* ถ้าไม่มี หน่วยจากให้ปิดหน้าต่างแล้วเปิดใหม่"
	        ...
	        <td class="style2"><font face='ms Sans Serif' size=1>&nbsp;<asp:Label ID="Label5" runat="server" Text="ที่ของผู้ให้ข่าว : "></asp:Label>
	...
	<tr><td><font face='ms Sans Serif' size=1>ผู้รับทราบ</font> :&nbsp;</td><td colspan=3>
        <input id="gtook" name="gtook" size="60" type="text" runat="server" /><font face='ms Sans Serif' size=1><asp:Label 
                        ID="Label9" runat="server" Text="ตั้งเวลาส่งข่าว : "></asp:Label>
                    &nbsp;
                    <asp:TextBox 
              ID="txttime" runat="server" Width="122px" Font-Names="MS Sans Serif" 
