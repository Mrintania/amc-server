  ...
  %>
            <table border="0" width="650" align="center">
              <tr> 
                ...
                <td width="50" align="right"><b>ชื่อ : </b></td>
...
//-->
              ...
              <tr> 
                <td width="150" align="right" colspan="2"><b>รู้จักเราจาก :</b></td>
                <td width="500"> 
                  <% =Rs("Ref") %>                </td>
              </tr>
              <tr> 
                <td width="150" align="right" colspan="2" valign="top"><b>คำแนะนำ 
                  :&nbsp;</b></td>
                <td width="500"> 
                  <% =getBR(Rs("Msg")) %>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;และ&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <tr> 
                <td width="150" align="right" colspan="2"><b>ส่งข้อความเมื่อ :</b>                </td>
                <td width="500"> 
                  <% =Rs("gDay") %>
                  &nbsp;&nbsp;</td>
              </tr>
