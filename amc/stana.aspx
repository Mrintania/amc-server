<%@ Page Language="VB" AutoEventWireup="false" CodeFile="stana.aspx.vb" Inherits="inbox" %>
...
<body style="background-color: black; color: white; font-family: Sans-Serif;">
    ...
    <div>
        <table style="background-color: darkgray">
            <tr>
                <td colspan="2" style="width: 3447px; height: 6px">
                    <span style="color: #000099; font-size: 11pt; font-family: MS Sans Serif;"><strong>AMC2009</strong></span></td>
            ...
            <table style="height: 43px; font-size: 14pt;">
                <tr>
                    <td colspan="3" style="width: 683px; height: 1px; text-align: left">
                        ...
                        <a href=composeStana.aspx?nid=<%=Request.QueryString("nid")%> target="_New">
                        <font face="ms Sans Serif" size="2" color=#ffffff><b>ส่งสรุปสถานการณ์ประจำวัน</b></font></a>
        ...
        <hr />
        <center>
            <font color="#ffffff" face="ms Sans Serif" size="1">Copyright © 2009 ศกม./สารสนเทศ กองทัพภาคที่
                2<br />
            </font>
        </center>
        <center>
