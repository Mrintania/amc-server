...
<center><br><br><br><br>
  <b><font face="Courier New, Courier, mono" size="3" color="#0066FF">...กรุณาระบุข้อมูลให้ครบด้วยครับ...</font></b><br>
                <input type="button" value="กลับไปแก้ไข" onclick='history.back();'>
</center>
<%        elseif IsNumeric(ICQ)=False then %>
               <center><br><br><br>
  <font color="#0066FF"><br>
  <b><font face="Courier New, Courier, mono" size="3">...หมายเลขบัญชีธนาคารต้องเป็นตัวเลขครับ...</font></b></font><br>
