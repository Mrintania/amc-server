<html>
<head>
<META HTTP-EQUIV="REFRESH" content="3;URL=jtb_re.asp">
<TITLE>confirm</title>
</head>
<body bgcolor=#ffffff>

<%
   gjtb_reconfirm=Request.QueryString("gjtb_reconfirm")
   gnumber=Request.QueryString("gnumber")
   Set Conn=Server.CreateObject("ADODB.Connection")
   Conn.Open ("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.Mappath("edi_out.mdb"))
   sql="Update t_com set jtb_reconfirm='"&Request.Form("gjtb_reconfirm")& "' where Qnumber="&Request.form("gnumber")
