<%@ Page Language="VB" AutoEventWireup="false" CodeFile="LoginTotal.aspx.vb" Inherits="NewTotal" %>
    ...
    <div>
            ...
            <tr>
                ...
                <td style="width: 345px; height: 19px">
                    <asp:Label ID="Label1" runat="server" Font-Names="MS Sans Serif" Font-Size="10pt"
                        Text="สรุปการ Login, Logout ณ เวลา " Width="162px"></asp:Label>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="จำนวน Login (ครั้ง)">
                    <HeaderStyle BackColor="Navy" />
                ...
                <asp:TemplateField HeaderText="จำนวน Logout (ครั้ง)">
                    <HeaderStyle BackColor="Navy" />
                    <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                    <ItemTemplate>
            ...
            <tr>
                ...
                <td style="width: 85px; height: 25px">
                    <asp:Label ID="Label3" runat="server" Font-Names="MS Sans Serif" Font-Size="10pt"
                        Text="Login" Width="56px"></asp:Label>
                </td>
            ...
            <tr>
                ...
                <td style="width: 85px; height: 24px;">
                    <asp:Label ID="Label5" runat="server" Font-Names="MS Sans Serif" Font-Size="10pt"
                        Text="Logout" Width="56px"></asp:Label></td>
