<%@ Page Language="VB" AutoEventWireup="false" CodeFile="addressStana.aspx.vb" Inherits="address" %>
...
<body style="background-color: lightgrey">
    ...
    <div>
        <table style="border-right: black thin solid; border-top: black thin solid; border-left: black thin solid;
            ...
            <tr>
                <td colspan="3" style="width: 279px; height: 1px">
                    <span style="color: #0000cc">&nbsp;<span style="font-size: 10pt"><strong>กรุณาเลือกหน่วยเหนือ</strong></span></span>
                    <asp:DropDownList ID="DropDownList1" runat="server" DataTextField="Up_name" Width="121px" AutoPostBack="True" DataValueField="Up_name">
                    </asp:DropDownList></td>
            </tr>
        </table>
