<html>
<head>
<META HTTP-EQUIV="REFRESH" content="3;URL=cav6.asp">
<TITLE>confirm</title>
</head>
<body bgcolor=#ffffff>

<%
   gcav6confirm=Request.QueryString("gcav6confirm")
   gnumber=Request.QueryString("gnumber")
   Set Conn=Server.CreateObject("ADODB.Connection")
   Conn.Open ("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.Mappath("edi_out.mdb"))
   sql="Update t_com set cav6confirm='"&Request.Form("gcav6confirm")& "' where Qnumber="&Request.form("gnumber")
