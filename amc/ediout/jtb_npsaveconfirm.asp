<html>
<head>
<META HTTP-EQUIV="REFRESH" content="3;URL=jtb_np.asp">
<TITLE>confirm</title>
</head>
<body bgcolor=#ffffff>

<%
   gjtb_npconfirm=Request.QueryString("gjtb_npconfirm")
   gnumber=Request.QueryString("gnumber")
   Set Conn=Server.CreateObject("ADODB.Connection")
   Conn.Open ("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.Mappath("edi_out.mdb"))
   sql="Update t_com set jtb_npconfirm='"&Request.Form("gjtb_npconfirm")& "' where Qnumber="&Request.form("gnumber")
