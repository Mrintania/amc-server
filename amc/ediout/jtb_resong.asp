...
<%
   ...
   sql="select * from jtb_resend"
   Set rs=Conn.Execute(SQL)
 %>

<FONT FACE="MS Sans SERIF" SIZE=2 color=#0000ff><B>ทะเบียนส่งเอกสาร</B></FONT>
<br>
<center>
...
<TD ALIGN = CENTER BGCOLOR="#cccccc">
<FONT FACE="MS Sans SERIF" SIZE=1 color=#0000ff><B>ผู้รับ</B></FONT>
</TD>
