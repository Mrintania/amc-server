<html>
<head>
<META HTTP-EQUIV="REFRESH" content="3;URL=mtb21.asp">
<TITLE>confirm</title>
</head>
<body bgcolor=#ffffff>

<%
   gmtb21confirm=Request.QueryString("gmtb21confirm")
   gnumber=Request.QueryString("gnumber")
   Set Conn=Server.CreateObject("ADODB.Connection")
   Conn.Open ("DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.Mappath("edi_out.mdb"))
   sql="Update t_com set mtb21confirm='"&Request.Form("gmtb21confirm")& "' where Qnumber="&Request.form("gnumber")
